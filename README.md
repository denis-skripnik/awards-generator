...
Если пользователь сохранил логин и ключ в LocalStorage браузера, выыводится текущая актуальная энергия.
...
4. Внедрить в форму и url возможность ввода не процента энергии, а суммы, на которую наградить;
5. Заказ дизайна.
